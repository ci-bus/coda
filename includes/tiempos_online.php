...
?>
		...
		<?php
			if(!isset($_GET['lang']) || $_GET['lang']==0 || $_GET['lang']=='0')
				{
				?>
				<div id="m_item1" onclick="cargar2('tiempos/p_inscritos.php?idprueba=<?php echo $idCarrera;?>&lang=0','capa','con_bus3')">INSCRITOS</div>
				<div id="m_item2" onclick="cargar2('tiempos/autorizados.php?idprueba=<?php echo $idCarrera;?>&lang=0','capa','con_bus3')">AUTORIZADOS</div>
				<div id="m_item3" onclick="cargar2('tiempos/clasificaciones.php?idprueba=<?php echo $idCarrera;?>&lang=0','capa','con_bus3')">CLASIFICACIONES</div>
				<div id="m_item4" onclick="cargar2('tiempos/abandonos.php?idprueba=<?php echo $idCarrera;?>&lang=0','capa','con_bus3')">ABANDONOS</div>
				<div id="m_item5" onclick="cargar2('tiempos/penalizaciones.php?idprueba=<?php echo $idCarrera;?>&lang=0','capa','con_bus3')">PENALIZACIONES</div>
		<?php
				}
			else{
			?>
				<div id="m_item1" onclick="cargar2('tiempos/p_inscritos.php?idprueba=<?php echo $idCarrera;?>&lang=1','capa','con_bus3')">STARTLIST</div>
				<div id="m_item2" onclick="cargar2('tiempos/autorizados.php?idprueba=<?php echo $idCarrera;?>&lang=1','capa','con_bus3')">AUTHORIZED</div>
				<div id="m_item3" onclick="cargar2('tiempos/clasificaciones.php?idprueba=<?php echo $idCarrera;?>&lang=1','capa','con_bus3')">CLASSIFICATIONS</div>
				<div id="m_item4" onclick="cargar2('tiempos/abandonos.php?idprueba=<?php echo $idCarrera;?>&lang=1','capa','con_bus3')">RETIREMENTS</div>
				<div id="m_item5" onclick="cargar2('tiempos/penalizaciones.php?idprueba=<?php echo $idCarrera;?>&lang=1','capa','con_bus3')">PENALTIES</div>
			<?php	} ?>
	...
	?>
            <table width="100%" id="tab_tem">
				...
				if ($tipo==1 || $tipo=='1')
					...
					if(!isset($_GET['lang']) || $_GET['lang']==0 || $_GET['lang']=='0')
						if($idCarrera==189)
							echo "<tr><th>Dorsal</th><th>Competidor</th><th>Equipo</th><th>Vehículo</th><th>Gr.</th><th>Copa</th><th>Cilin.</th></tr>";
						else
							echo "<tr><th>Dorsal</th><th>Competidor</th><th>Equipo</th><th>Vehículo</th><th>Gr.</th><th>Cl.</th><th>Cilin.</th></tr>";
					else
						if($idCarrera==189)
							echo "<tr><th>Car No</th><th>Contestant</th><th>Team</th><th>Car</th><th>Gr.</th><th>Cup</th><th>C.C</th></tr>";
						else
