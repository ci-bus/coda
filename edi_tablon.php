...
?>	
			...
			<div class="section-top-border">
						<h3 class="mb-30">DOCUMENTACI&Oacute;N PREVIA:</h3>
							<a href="subir_comp.php?tipo=previa&id=<?php echo $id;?>"><span>SUBIR ARCHIVO</span></a>
						<?php
						$previa = mysql_query("SELECT * FROM infoprevia WHERE idcarreras='$id'");
						if(mysql_num_rows($previa)>0)
							{
								$par=0;
							echo '<table width="100%">';
							while($fila=mysql_fetch_array($previa))
								{
								if($par%2==0)
									$classcss="filapar";
								else
								...
								echo '<tr class="'.$classcss.'"><td>'.$activo.'</td><td><a href="http://codea.es/'.$archivo.'" target="_blank">'.$titulo.'</a></td><td><a class="confir" href="borrar.php?id='.$id.'&idinfo='.$idinfo.'&tipo=previa&temporada='.$temporada.'&archivo='.$archivo.'">BORRAR</a></td></tr>';
								$par++;
								}
							echo '</table>';
							}
			...
			<div class="section-top-border">
						<h3 class="mb-30">DOCUMENTACI&Oacute;N DE CARRERA:</h3>
							<a href="subir_comp.php?tipo=carrera&id=<?php echo $id;?>"><span>SUBIR ARCHIVO</span></a>
						<?php
						$carrera = mysql_query("SELECT * FROM infocarrera WHERE idcarreras='$id'");
						if(mysql_num_rows($carrera)>0)
							{
								$par=0;
							echo '<table width="100%">';
							while($fila=mysql_fetch_array($carrera))
								{
								if($par%2==0)
									$classcss="filapar";
								else
								...
								$idinfo = $fila['idInfo'];
								$archivo = $fila['archivo'];
								echo '<tr class="'.$classcss.'"><td>'.$activo.'</td><td><a href="http://codea.es/'.$archivo.'" target="_blank">'.$titulo.'</a></td><td><a class="confir" href="borrar.php?id='.$id.'&idinfo='.$idinfo.'&tipo=carrera&temporada='.$temporada.'&archivo='.$archivo.'">BORRAR</a></td></tr>';
								$par++;
								}
							echo '</table>';
							}
			...
			<div class="section-top-border">
						...
						<a href="subir_comp.php?tipo=comisarios&id=<?php echo $id;?>"><span>SUBIR ARCHIVO</span></a>
						<?php
						$comisarios = mysql_query("SELECT * FROM infocomisarios WHERE idcarreras='$id'");
						if(mysql_num_rows($comisarios)>0)
							{
								$par=0;
							echo '<table width="100%">';
							while($fila=mysql_fetch_array($comisarios))
								{
								if($par%2==0)
									$classcss="filapar";
								else
								...
								$idinfo = $fila['idInfo'];
								$archivo = $fila['archivo'];
								echo '<tr class="'.$classcss.'"><td>'.$activo.'</td><td><a href="http://codea.es/'.$archivo.'" target="_blank">'.$titulo.'</a></td><td><a class="confir" href="borrar.php?id='.$id.'&idinfo='.$idinfo.'&tipo=comisarios&temporada='.$temporada.'&archivo='.$archivo.'">BORRAR</a></td></tr>';
								$par++;
								}
							echo '</table>';
							}
			...
			<div class="section-top-border">
						...
						<a href="subir_comp.php?tipo=direccion&id=<?php echo $id;?>"><span>SUBIR ARCHIVO</span></a>
						<?php
						$direccion = mysql_query("SELECT * FROM infodireccion WHERE idcarreras='$id'");
						if(mysql_num_rows($direccion)>0)
							{
								$par=0;
							echo '<table width="100%">';
							while($fila=mysql_fetch_array($direccion))
								{
								if($par%2==0)
									$classcss="filapar";
								else
								...
								$idinfo = $fila['idInfo'];
								$archivo = $fila['archivo'];
								echo '<tr class="'.$classcss.'"><td>'.$activo.'</td><td><a href="http://codea.es/'.$archivo.'" target="_blank">'.$titulo.'</a></td><td><a class="confir" href="borrar.php?id='.$id.'&idinfo='.$idinfo.'&tipo=direccion&temporada='.$temporada.'&archivo='.$archivo.'">BORRAR</a></td></tr>';
								$par++;
								}
							echo '</table>';
							}
