...
WHERE ca.id_ca_carrera='$idCarrera'";
	$resultadoFiltroCopas = mysql_query($dbQueryFiltroCopas);
	   if($copa=='0'){
				...
				echo "<option value='clas_final_newb.php?id=".$idCarrera."&newBD=true&campeonato=0&copa=0'>TODAS LAS COPAS</option>";
	   }
	while($row=mysql_fetch_array($resultadoFiltroCopas))
		...
		$filtroDesc = $row["descripcion"];
			...
			echo "<option value='clas_final_newb.php?id=".$idCarrera."&newBD=true&campeonato=0&copa=".$row['id']."'>".$filtroDesc."</option>";
		}	
echo "</select></td>";
echo "</tr></table>";
echo "<hr><p>CLASIFICACI&Oacute;N FINAL:</p>";
				...
				switch($tipo_prueba){
						case 0: {
								if($idCarrera=='29')
									...
									include("clas_final_tipo3b.php");
							}
						break;
						case 1: include("clas_final_tipo1b.php");
						break;
						case 2: include("clas_final_tipo2b.php");
						break;
						case 3: include("clas_final_tipo3b.php");
						break;
