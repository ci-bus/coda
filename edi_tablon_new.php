...
?>	
			...
			<div class="section-top-border">
						<h3 class="mb-30">DOCUMENTACI&Oacute;N PREVIA:</h3>
							<a href="subir_comp_new.php?tipo=previa&id=<?php echo $id;?>&newBD=true&usuario=<?php echo $usuario;?>"><span>SUBIR ARCHIVO</span></a>
						<?php
						$info = mysql_query("SELECT nombre,url_archivo,orden,id FROM abc_57os_ca_carrera_archivo
						WHERE id_ca_carrera='$idCarrera' AND tipo='previa' ORDER BY orden ASC");
