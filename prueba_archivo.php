	...
	<body>
		...
		if (isset($_GET["id"])) {
			$idCarrera = $_GET["id"];
			if (isset($idCarrera)) {
				$dbQuery = "SELECT web AS prueba_web,titulo AS nombre,fecha_larga,img_prueba AS cartel,tipo AS tipo_p,organizador,
				img_organizador,img_sponsor,web,ruta_tablon FROM web_pruebas_archivo WHERE idcarrera = '$idCarrera'";
			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center justify-content-start">
					<div class="banner-content col-lg-7">
						...
						if ($web == 0) {
							if ($ruta_tablon == '') {
								echo "<a href='tablon_archivo.php?id=" . $idCarrera . "' class='primary-btn text-uppercase'>TABL&Oacute;N DE ANUNCIOS</a>";
								echo "<a href='tiempos_archivo.php?id=" . $idCarrera . "' class='primary-btn text-uppercase'>VER TIEMPOS ONLINE</a>";
							} else {
