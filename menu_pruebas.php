    ...
    <a href="excluidos_new.php?id=<?php echo $idCarrera; ?>" class="primary-btn text-uppercase <?php if($activo=='excluidos')echo "selected";?>"><img src="img/excluido.png" class="iconos_menu">DESCALIFICACIONES</a>
    ...
    <a href="clas_final_new.php?id=<?php echo $idCarrera; ?>&copa=0" class="primary-btn text-uppercase <?php if($activo=='clasificacion')echo "selected";?>"><img src="img/podio.png" class="iconos_menu">CLASIFICACI&Oacute;N FINAL</a>
