...
$pass = $_POST['pass'];
$id = $_POST['id'];
$sql = mysql_query("SELECT pass FROM secretarios WHERE prueba='$id' AND pass='$pass'");
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content margen1">
								...
								<p class="text-white">VALIDANDO ACCESO</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="section-top-border">
						...
						<?php
							if(mysql_num_rows($sql)>0)
								...
								session_start();
								$_SESSION['pass']= $pass;
								echo '<META HTTP-EQUIV=Refresh CONTENT="1; URL=edi_tablon.php?id='.$id.'">';
								}
							else{
								echo "Usuario INVALIDO..... REDIRIGIENDO....";
								echo '<META HTTP-EQUIV=Refresh CONTENT="1; URL=acceso.php?id='.$id.'">';
								}
