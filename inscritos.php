...
mysql_query ("SET NAMES 'utf8'");
mysql_select_db($nombreBD) or die('no se encontro la bd');
mysql_query ("SET NAMES 'utf8'");//Lo hago arriba para saber el Título de la prueba
...
$dbQuery = "SELECT * FROM inscritos WHERE idcarreras = 'A20' AND autorizado = '1' ORDER BY dorsal ASC";
