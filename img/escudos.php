	...
	function escudo($cadena)
		{
			...
			elseif(stristr($cadena, 'abart') == TRUE){
			   return "<img src='escudos/abarth.png' width='40px'>";
			}
			elseif(stristr($cadena, 'brc') == TRUE){
			   return "<img src='escudos/brc.png' width='40px'>";
			}
			elseif(stristr($cadena, 'herrad') == TRUE){
			   return "<img src='escudos/herrador.png' width='40px'>";
			}
			elseif(stristr($cadena, 'polari') == TRUE){
			   return "<img src='escudos/polaris.png' width='40px'>";
			}
			elseif(stristr($cadena, 'silver') == TRUE){
			   return "<img src='escudos/renault.png' width='40px'>";
			}
			elseif(stristr($cadena, 'talex') == TRUE){
			   return "<img src='escudos/talex.png' width='40px'>";
			}
			elseif(stristr($cadena, 'ACIA') == TRUE){
			   return "<img src='escudos/dacia.png' width='40px'>";
			}
