		...
		<body>
			...
			<section class="generic-banner">				
				<div class="container">
					...
					<a href="#" class="primary-btn text-uppercase">ENLACES EXTERNOS A C.D CODA</a>
				</div>
			</section>		
					<div class="section-top-border">
						<?php
						$par=0;
						$sql = "SELECT titulo,enlace FROM web_enlaces WHERE id_carrera ='$idCarrera'";
						$enlaces = mysql_query($sql) or print ("error");
							if(mysql_num_rows($enlaces)>0)
								{
								while($fila=mysql_fetch_array($enlaces))
									{
									$titulo = $fila['titulo'];
									$enlace = $fila['enlace'];
									echo "<h3>".$titulo."</h3>";
									echo "<p><a href='".$enlace."' target='_blank'>".$enlace."</a></p><br>";
									}
								}
							else
