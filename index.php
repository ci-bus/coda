...
<div class="contain">
            ...
            <div class="wrapper">
                <div id="ei-slider" class="ei-slider">
					...
					?>
                        <!--li>
                            <img src="slider/homezurgena.jpg" alt="image01" />
                            <div class="ei-title">
                                <h2>9 y 10 de Marzo de 2019</h2>
                                <h3>I Rallye Crono Zurgena</h3>
                            </div>
                        </li>
                        <li>
                            <img src="slider/homelorca.jpg" alt="image02"/>
                            <div class="ei-title">
                                <h2>8 Y 9 DE MARZO DE 2019</h2>
                                <h3>VIII Tierras Altas de Lorca</h3>
                            </div>
                        </li-->
			...
			<section class="gallery-area section-gap" id="gallery">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-12">
						<div id="p3">
								<!-- LightWidget WIDGET --><script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/ac28b9ab30125ca78f28f51ad5ecb993.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe>
