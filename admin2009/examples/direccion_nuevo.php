          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Nueva Direccion de Carrera</h5>
              </div>
              <div class="card-body">
                <form action="direccion_nuevo_guardar.php?newBD=true" method="post" enctype="multipart/form-data">
                  <div class="row">
                        ...
                        <select class="form-control" name="id">
							...
							$sql=mysql_query("SELECT id,nombre FROM abc_57os_ca_carrera WHERE estado!=5 AND temporada='$anio' AND prueba_web=0");
								if(mysql_num_rows($sql)>0)
									...
									echo "<option>No existen carreras para ".$anio."</option>";
