      ...
      <div class="content">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">TIEMPOS API GPS</h5>
                
              </div>
              <div class="card-body">
				<div class="chart-area">
				<a href="intermedios.php?activo=extras&newBD=true">
                  <img src="img/gps.jpg">  </a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">PANTALLA TIEMPOS</h5>
                
              </div>
              <div class="card-body">
				<div class="chart-area">
					<a href="panel_tiempos.php?activo=extras&newBD=true">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">PANTALLA DIRECCION</h5>
              </div>
              <div class="card-body">
				<div class="chart-area">
				<a href="http://coda2019.codea.es/direccion/index.html">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">FOTOS PILOTOS Y EQUIPOS</h5>
                
              </div>
              <div class="card-body">
				<div class="chart-area">
                  <a href="fotos.php?activo=extras&newBD=true"><img src="img/fotos.jpg"> </a>
                </div>
              </div>
            </div>
          </div>
		  <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">ULTIMA HORA EN PAGINA WEB</h5>
                
              </div>
              <div class="card-body">
				<div class="chart-area">
                  <a href="ult_hora.php?activo=extras&newBD=true"><img src="img/ult_hora.jpg"></a>
                </div>
              </div>
            </div>
          </div>
