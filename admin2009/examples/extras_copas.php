      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">SINCRONIZAR COPAS / INCRITOS COPAS SISTEMA > -- > WEB</a>
          </div>
						...
						$sql=$mysqli2->query("SELECT titulo,idcarrera FROM web_pruebas ORDER BY idcarrera DESC");
							if($sql->num_rows==0)
								...
								while($fila=$sql->fetch_array())
									...
									$id = $fila['idcarrera'];
									$nombre = $fila['titulo'];	
									echo "<tr><td><a href='../../insert_copas.php?id=".$id."' target='_blank'>".$nombre."</a></td></tr>";
									}
								}
					  ?>
                    </tbody>
