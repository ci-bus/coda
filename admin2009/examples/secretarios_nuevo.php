      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">NUEVO SECRETARIO WEB</a>
          </div>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Nuevo Secretario Web</h5>
              </div>
              <div class="card-body">
                <form action="secretarios_nuevo_guardar.php?newBD=true" method="post">
				<div class="row">
                    <div class="col-md-8">
