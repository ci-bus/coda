      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">GPS API ONLINE</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <h4 class="card-title"> SELECCIONAR MANGA A CARGAR:</h4>
              </div>
              <div class="card-body">
						...
						WHERE e.id_ca_carrera = '$id'");
							if($sql->num_rows==0)
								...
								while($fila=$sql->fetch_array())
									...
									$manga = $fila['manga'];	
									echo "<tr><td><a href='int_gps.php?idmanga=".$idmanga."&id=".$id."' target='_blank'>".$manga."</a></td></tr>";
									}
								}
					  ?>
                    </tbody>
