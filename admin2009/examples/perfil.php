...
$sql=mysql_query("SELECT * FROM web_usuarios WHERE id='$uss'");
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">PERFIL USUARIO</a>
          </div>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Editar Perfil de Usuario</h5>
              </div>
              <div class="card-body">
                <form action="perfil_guardar.php?newBD=true" method="post" enctype="multipart/form-data">
                  <div class="row">
					...
					<div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $telf?>" name="mail">
                      </div>
                    </div>
                  </div>
                  <div class="row">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-fill btn-primary" disabled="disabled">Guardar</button>
              </div>
			  </form>
            </div>
          </div>
                ...
                <p class="card-text">
                  <div class="author">
                    ...
                    <a href="javascript:void(0)">
                      <img class="avatar" src="../assets/img/<?php echo $imagen;?>" alt="...">
