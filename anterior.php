			...
			<div class="row height align-items-center justify-content-center">
				<div class="col-lg-10">
					<div class="generic-banner-content margen1">
						<h2 class="text-white">Eventos para la Temporada <?php echo $temporada; ?></h2>
	...
	<div class="section-top-border">
		...
		<table border='0' width='100%' id='tab_tem'>
			...
			<tbody>
				...
				$dbQuery = "SELECT idcarrera AS id, titulo AS nombre, fecha_larga,organizador,fecha,poblacion,web FROM web_pruebas_archivo
WHERE estado!=5 AND temporada='$temporada'
ORDER BY fecha DESC";
			...
			<td>" . $fecha_larga . "</td>
			<td>" . $poblacion . "</td>
			<td><a href='prueba_archivo.php?id=" . $idCarrera . "'>" . $nombre . "</a></td>
